...
export default function Page() {
  return (
    ...
    >
      {/* Box container */}
      <div className="w-[45rem] h-[30rem] rounded-3xl grid grid-cols-2 grid-rows-1">
        {/* Result box */}
        <div className="flex flex-col items-center gap-8 py-6 rounded-3xl bg-gradient-to-b from-[#7857FF] to-[#2E2BE9]">
          ...
          <p className="text-3xl font-semibold leading-tight tracking-wide text-white">
            Great
          </p>
          <p className="max-w-xs text-base font-medium text-center text-gray-400">
            You scored higher than 65% of the people who had taken these tests
          </p>
        </div>
        {/* Summary box */}
